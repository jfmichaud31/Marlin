...
#define STRING_CONFIG_H_AUTHOR "(JF Michaud, Anet config)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // ANET A8 Standard Extruder with sock on and 220 Degree Celcius and 60% Fan
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 400, 97.5 }
